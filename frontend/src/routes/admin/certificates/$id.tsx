      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="bg-slate-900/50 backdrop-blur-sm border border-slate-800 rounded-2xl p-8 sm:p-12 shadow-2xl">
          <div className="text-center mb-8 pb-8 border-b border-slate-800">
            ...
            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2">Certificate of Completion</h1>
            <p className="text-slate-400">Issued by Secure Certificates Authority</p>
          </div>

          <div className="space-y-6">
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-slate-500 mb-2">Certificate Holder</label>
                <p className="text-xl font-semibold text-white">{certificate.ownerName}</p>
              </div>
              <div>
                <label className="block text-sm font-medium text-slate-500 mb-2">Study/Course</label>
                <p className="text-xl font-semibold text-white">{certificate.study}</p>
              </div>
            </div>

            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                <label className="block text-sm font-medium text-slate-500 mb-2">Issue Date</label>
            ...
            <div>
              <label className="block text-sm font-medium text-slate-500 mb-2">Certificate ID</label>
      ...
      <RevokeModal
        ...
        onConfirm={async (reason) => {
          ...
          try {
            ...
            const message = JSON.stringify({ action: "REVOKE", target: certificate.id });
